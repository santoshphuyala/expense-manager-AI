...
class ExpenseTrackerApp {
    ...
    convertToCSV(data) {
        const headers = ['Date', 'Type', 'Category', 'Description', 'Amount', 'Account', 'Currency', 'Notes'];
        ...
        reader.onload = async (e) => {
            try {
                ...
                if (filename.endsWith('.json')) {
                    ...
                    this.showToast(`Imported ${imported} transactions!`, 'success');
                    ...
                    this.showToast(`Imported ${jsonData.length} transactions!`, 'success');
                }
